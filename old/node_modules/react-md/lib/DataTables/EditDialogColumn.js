(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-dom', 'classnames', '../constants/keyCodes', '../constants/CSSTransitionGroupTick', '../utils/getField', '../utils/EventUtils/handleWindowClickListeners', '../utils/PropTypes/invalidIf', '../Dialogs/DialogFooter', './TableColumn', '../TextFields/TextField', '../FontIcons/FontIcon', './findTable'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-dom'), require('classnames'), require('../constants/keyCodes'), require('../constants/CSSTransitionGroupTick'), require('../utils/getField'), require('../utils/EventUtils/handleWindowClickListeners'), require('../utils/PropTypes/invalidIf'), require('../Dialogs/DialogFooter'), require('./TableColumn'), require('../TextFields/TextField'), require('../FontIcons/FontIcon'), require('./findTable'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactDom, global.classnames, global.keyCodes, global.CSSTransitionGroupTick, global.getField, global.handleWindowClickListeners, global.invalidIf, global.DialogFooter, global.TableColumn, global.TextField, global.FontIcon, global.findTable);
    global.EditDialogColumn = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _reactDom, _classnames, _keyCodes, _CSSTransitionGroupTick, _getField, _handleWindowClickListeners, _invalidIf, _DialogFooter, _TableColumn, _TextField, _FontIcon, _findTable) {
  'use strict';
